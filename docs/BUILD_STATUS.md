...
- Tightened Business Details to equal-width, left-aligned label/value columns, including compact address and description rows, and raised the dining-table guidance contrast. After user review, table count uses direct numeric/numpad entry constrained to 1–200 with desktop spinner arrows hidden; the experimental wheel was removed.
