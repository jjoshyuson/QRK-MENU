...
class SupabaseDataService{
  ...
  async listOrders(){
    if(!(this.config.staffAccessToken||globalThis.QRK_ACCESS_TOKEN)){await this.registerDevice();return this.rpc('list_device_orders',{p_destination_slug:this.destinationSlug,p_device_id:this.device.id,p_device_secret:this.device.secret})}
