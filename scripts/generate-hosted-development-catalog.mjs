...
const prefixes = { 'kusina-manila': '10', salamat: '21', 'salo-table': '31', 'tambay-tab': '41', 'ihaw-buffet': '51' };
const orderPrefixes = { 'kusina-manila': 'KM', salamat: 'SA', 'salo-table': 'ST', 'tambay-tab': 'TC', 'ihaw-buffet': 'IB' };
