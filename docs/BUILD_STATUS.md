...
- Restyled the phone/tablet floating checkout action and item-sheet Add to order action as one shared, fully pill-shaped liquid-glass control. A mostly neutral translucent surface, restrained brand tint, backdrop blur, thin refractive rim, and quiet depth replace the earlier saturated wash and broad glossy highlight. The existing content, position, footer avoidance, and checkout behavior are unchanged.
