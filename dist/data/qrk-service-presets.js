...
export const DEVELOPMENT_CLIENTS=[
  {id:'kusina-manila',businessName:'Kusina Manila',slug:'kusina-manila',prefix:'kusina',description:'Filipino favorites, made with love.',serviceProfile:{preset:'quick',locationName:'Ermita'},admin:{name:'Jonathan Yuson',email:'owner@kusinamanila.example',username:'kusina-admin'},menu:[['Mains','Chicken adobo',18000],['Mains','Sinigang na baboy',22000],['Drinks','Calamansi iced tea',6500]]},
