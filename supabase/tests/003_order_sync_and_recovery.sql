...
select lives_ok($$select public.create_device_order('kusina-manila','40000000-0000-4000-8000-000000000101','pickup',null,'Device test','', '[{"itemId":"10000000-0000-4000-8000-000000000501","quantity":1,"optionIds":["10000000-0000-4000-8000-000000000701"]}]','40000000-0000-4000-8000-000000000001','40000000-0000-4000-8000-000000000001-secret-value')$$,'registered device creates an order');
