...
- Keep both halves of grouped-field rows left-aligned and approximately equal width, including compact multiline values. Use the shared scroll-snap number wheel for bounded counts instead of exposing desktop spinner arrows inside a material sheet.
