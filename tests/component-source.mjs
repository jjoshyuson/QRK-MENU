...
for (const route of routeFiles) {
  ...
  assert.match(html, /href="\/ui-components\.css\?v=11"/, `${route} must load the shared visual source`);
  assert.match(html, /src="\/ui-components\.js\?v=7"/, `${route} must load stable inspector labels`);
}
