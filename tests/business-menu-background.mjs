...
const kusina={businessSlug:'kusina-manila',businessName:'Kusina Manila'};
const salamat={businessSlug:'salamat',businessName:'Salamat'};
assert.deepEqual(getBusinessBrand(kusina).publicMenuBackground,{image:'/assets/businesses/kusina-manila-banner.webp',surfaceOpacity:.72});
