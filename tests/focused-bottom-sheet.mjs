...
assert.match(menu, /card\?\.animate\(\[\{transform:'translate3d\(0,14px,0\)'\},\{transform:'translate3d\(0,0,0\)'\}\]/);
assert.match(menu, /duration:180,easing:'cubic-bezier\(\.2,\.8,\.2,1\)'/);
assert.match(menu, /duration:160,easing:'cubic-bezier\(\.4,0,\.8,\.2\)'/);
