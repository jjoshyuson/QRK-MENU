...
| 0.33 Component inventory | Complete locally | Unlinked static catalog makes reusable owner, admin, staff and customer UI easy to find, compare and copy | Existing production UI and design tokens | Fifteen component families and representative states render at phone, tablet and desktop widths; future additions are governed by `AGENTS.md` |
