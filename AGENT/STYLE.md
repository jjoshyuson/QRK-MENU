...
- Consolidate an item's persistent options and add-ons in one scannable sheet. Put circular cancel and confirm controls at the top-left and top-right, keep the calculated price informational in a separate bottom row, and reveal optional free text only after the customer taps its row.
