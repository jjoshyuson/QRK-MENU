...
- Validation: `npm run check`, `git diff --check`, live QR token issue/resolve, all seven public entry variants, and a customer request appearing in the matching Client Admin Tables queue passed locally. No hosted or production database was changed.
