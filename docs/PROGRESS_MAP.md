...
| 1.11 Order source of truth and recovery | Implemented in source; database runs blocked | PostgreSQL-backed device identity, submitted orders, operational archive batches, and restoration of the newest two clears | Local Docker; hosted Supabase login/project ref | Local pgTAP and hosted two-device evidence pass; restaurant/menu/product data remains unchanged through clear/restore |
